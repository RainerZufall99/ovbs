...
import Azure from "../../assets/Teneo.png";
                    ...
                    <div className={styles.chatContainer}>
                        {!lastQuestionRef.current ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle}>Dokument: Bedingungen Wohngebäude VGH</h2>
                            </Stack>
                        ) : (
                        ...
                        <Stack horizontal className={styles.chatInput}>
                            ...
                            <div
                                ...
                                <BroomRegular
                                    ...
                                    style={{ background: isLoading || answers.length === 0 ? "#BDBDBD" : "radial-gradient(109.81% 107.82% at 100.1% 90.19%, #5d34a2 33.63%, #AC2463 70.31%, #DD1B3d 100%)", 
